    ...
    public class OracleArm extends Sprite {
		...
		public function OracleArm (
			...
			if (myDescriptorImage) {
				myOrbLoader = new Loader();
				myOrbLoader.load(new URLRequest(myDescriptorImage));
				myOrbLoader.contentLoaderInfo.addEventListener(Event.COMPLETE, fixOrb);
				myInnerOrb.addChild(myOrbLoader);
				myOrb.addChild(myInnerOrb);
			} 
