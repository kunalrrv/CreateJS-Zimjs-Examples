package com.danzen.interfaces {
	...
	public class Report extends MovieClip {
		...
		public function Report(theTitle:MovieClip, theW:Number, theH:Number, theDrag:Boolean, theColNames:Array, theColWidths:Array, theProvider:DataProvider, theAlpha:Number = .7, theCurve:Boolean = true) {
			
			trace ("hi from Report");
