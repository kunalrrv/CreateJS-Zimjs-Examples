package com.danzen.utilities  {
	...
	// once you have made the classes folder - for example c:\classes then add the folder to your class path
	...
	// in general, the document class is the class that gets called when you test or publish your FLA
	// the document class has a package declaration as its first line
	// just inside that you need to import com.danzen.packagename.ClassName; along with other classes you use
	// there is a class definition and inside that is a constructor method that gets run first
